...
export const campaignData = [
  {
    id: 1,
    title: 'Offer on Medical Checkup',
    date: '3 days ago',
    type: 'email',
    sendTo: 'All Patients',
    action: {
      subject: 'Medicare patients with a free Medical checkup',
      message:
        'Dear Patient, We are Medicareed to offer you a free Medical checkup. Please visit our clinic to avail this offer. Thank you. and have a nice day. and welcome to our clinic.',
      subHeader: 'Offer on Medical Checkup',
  ...
  },
  {
    ...
    action: {
      message:
        'Hellow Patient, are you looking for a free Medical checkup? We are Medicareed to offer you a free Medical checkup. Please visit our clinic to avail this offer. Thank you.',
    },
  },
  {
    id: 3,
    ...
    action: {
      message:
        'Hola, Medicare patient with NHCF Insurance, We are Medicareed to offer you a free Medical checkup. Please visit our clinic to avail this offer. Thank you.',
    },
  },
  {
    id: 4,
    ...
    action: {
      message:
        'Medicare Patient, now get 50% off on Medical checkup. Please visit our clinic to avail this offer. Thank you. and have a nice day. and welcome to our clinic.',
    },
  },
  {
    id: 5,
    ...
    action: {
      subject: 'Medicare patients with a free Medical checkup',
      message:
        'Dear Patient, Britam Insurance is Medicareed to offer you a free Medical checkup. Please visit our clinic to avail this offer. Thank you. and have a nice day. and welcome to our clinic.',
  ...
  },
  {
    ...
    action: {
      message:
        'Hola, Medicare patient with Teeth Whitening Offer, We are Medicareed to offer you a free Medical checkup. Please visit our clinic to avail this offer. Thank you.',
    },
  },
];
...
export const invoicesData = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        price: 260,
        description: 'Medical Implants Treatment',
      },
      {
        id: 4,
        name: servicesData[3].name,
        price: 190000,
        description: 'Medical Crowns Treatment',
      },
      {
        id: 5,
        name: servicesData[4].name,
        price: 15000,
        description: 'Medical Bridges Treatment',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        price: 5000,
        description: 'Medical Veneers Treatment',
      },
      {
        id: 2,
        name: servicesData[6].name,
        price: 16000,
        description: 'Medical Braces Treatment',
      },
      {
        id: 3,
        name: servicesData[7].name,
        price: 10000,
        description: 'Medical Sealants Treatment',
      },
      {
        id: 4,
        name: servicesData[8].name,
